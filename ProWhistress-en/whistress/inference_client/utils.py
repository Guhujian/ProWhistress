...
LOCAL_WHISPER_MODEL = pathlib.Path(__file__).parent.parent / "whisper_model" / "whisper-small.en"


def get_loaded_model(device="cuda", model_path=None):
    """
    Load the WhiStress model.
    ...
    whisper_backbone = str(LOCAL_WHISPER_MODEL) if LOCAL_WHISPER_MODEL.exists() else "openai/whisper-small.en"
